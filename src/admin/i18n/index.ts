const en = {
  admin: {
    ...
    onboarding: {
      ...
      items: {
        signup_submitted: 'Sign up',
        email_verified: 'Verify email',
        tenant_created: 'Create workspace',
        owner_assigned: 'Assign owner access',
        first_project_setup: 'Complete first project/site setup',
      },
      funnel: {
        ...
        firstProject: 'First project/site setup',
        invite: 'Team invited',
